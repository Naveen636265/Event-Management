...
<br>
    <header class="header">
        <div class="container">
            <h1 class="text-center ani1">WEDDING PACKAGES</h1>
            <center>
            <p class="text-center"><h3>TURNING DREAMS INTO REALITY</h3></p>
            </center>
            <p class="text-center">We'll make sure your wedding day is everything you’ve ever dreamed of. Contact us for a free consultation and let us help plan the perfect day. We’ll work with you every step of the way to make sure everything is exactly as you’ve envisioned, so you can sit back, relax, and enjoy the ride!</p>
        </div>
    </header>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 mb-4 ">
                    <div class="card">
                        <img src="41.jpg" class="card-img-top" alt="Package 1" style="width: 348px; height: 300px;">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4 ">
                    <div class="card">
                        <img src="42.jpg" class="card-img-top" alt="Package 2">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4 ">
                    <div class="card">
                        <img src="43.jpg" class="card-img-top" alt="Package 3" style="width: 348px; height: 300px;">
                        <div class="card-body">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="w3.jpeg" class="card-img-top" alt="Package 3" style="width: 310px; height: 300px;">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="w2.jpeg" class="card-img-top" alt="Package 3" style="width: 310px; height: 300px;">
