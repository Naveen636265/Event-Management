...
<!-- <%@ page language="java" contentType="text/html; charset=UTF-8" 
    ...
    <br>
        <header class="header">
            <div class="container">
                <h1 class="text-center ani1">DJ EVENTS</h1>
                <center>
                <p class="text-center"><h3>MAKE YOUR EVENT MEMORABLE</h3></p>
                </center>
                <p class="text-center">We'll make sure your event is one to remember. Contact us for a free consultation and let us help plan the perfect celebration. We'll work with you every step of the way to make sure everything is exactly as you’ve envisioned, so you can sit back, relax, and enjoy the ride!</p>
                </div>
        </header>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 mb-4 ">
                        <div class="card">
                            <img src="dj1.jpeg" class="card-img-top" alt="Package 1" style="width: 348px; height: 300px;">
                            <div class="card-body">
                    ...
                    <div class="col-md-4 mb-4 ">
                        <div class="card">
                            <img src="dj2.jpeg" class="card-img-top" alt="Package 2" style="width: 348px; height: 500px;">
                            <div class="card-body">
                    ...
                    <div class="col-md-4 mb-4 ">
                        <div class="card">
                            <img src="dj3.jpeg" class="card-img-top" alt="Package 3" style="width: 348px; height: 300px;">
                            <div class="card-body">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <img src="dj4.jpeg" class="card-img-top" alt="Package 3" style="width: 310px; height: 300px;">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <img src="dj6.jpeg" class="card-img-top" alt="Package 3" style="width: 310px; height: 300px;">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <img src="dj5.jpeg" class="card-img-top" alt="Package 3" style="width: 310px; height: 300px;">
